...
import threading
from scraper import init_driver, scrape_playlists, scrape_songs_from_url_list, load_json, save_json
from scraper import SCRAPED_PLAYLISTS_FILE
...
class SunoScraperApp(tk.Tk):
    ...
    def scrape_playlists_thread(self):
        ...
        try:
            self.playlists = scrape_playlists(self.driver, self.log, self.update_progress_playlist)
    ...
    def scrape_songs_thread(self):
        ...
        try:
            scrape_songs_from_url_list(self.scraped_playlists, self.driver, self.log, self.update_progress_song, self.update_progress_playlist)
    ...
    def update_progress_playlist(self):
        self.playlist_progress['value'] += 1

    def update_progress_song(self):
